...
export const MainSection = () => {
  return (
    <div className="flex p-24 dark:bg-gray-950 w-full">
      <div className="flex flex-1 flex-col gap-8">
        <div className="flex flex-col gap-1">
          <h1 className="font-semibold text-gray-900 dark:text-gray-50 text-6xl">{`Hi, I'm Tom 👋`}</h1>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex gap-1 items-center pl-1">
            <LocationIcon />
            <p className="dark:text-gray-50">Ulaanbaatar, Mongolia</p>
          </div>
          <div className="flex gap-1 items-center">
            <div className="p-2 h-2 m-2 bg-green-500 rounded-full"></div>
            <p className="dark:text-gray-50">Available for new projects</p>
          </div>
        </div>
